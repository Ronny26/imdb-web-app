  ...
  try {
    ...
    if(response.data == null){
      ...
      movie = {
        ...
        primaryImage: movieResponse.data.results.primaryImage ? movieResponse.data.results.primaryImage.url : {url:"https://www.dotyeti.com/wp-content/uploads/2023/01/barbie.webp"},
